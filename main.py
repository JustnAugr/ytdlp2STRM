...
if __name__ == "__main__":
    ...
    # TODO: I hate the structure of this - the weird circular nature of having socketio in ui.routes for some reason, and then needing the empty import to grab the routes for the plugin. I'll clean this up eventually, but a needed evil for now
    import plugins.youtube.routes  # pyright: ignore # noqa: F401
    ...
    thread_clean_old_videos = Thread(
        target=folders_instance.clean_old_videos, args=(stop_event,)
    )
